  ...
  return domains.flatMap((domain) => {
    ...
    return domain.dimensions.map((dimension) => {
      ...
      return {
        ...
        questions: responseQuestions.length
          ? responseQuestions
          : fallbackQuestions,
      } as ReviewDimension;
    });
...
export default function ReviewPage({
  ...
  const answeredCount = useMemo(() => {
    ...
    return currentDimension.questions.filter((q) => parseAnswer(q.answer))
      .length;
  }, [currentDimension]);
        ...
        <div className='lg:col-span-2 space-y-6'>
          ...
          <div className='flex flex-wrap items-center gap-3 mb-6'>
            ...
            {currentDimIndex === dimensions.length - 1 ? (
              <Link
                href={`/admin/consultant/${consultantId}/companies`}
                className='flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-all bg-accent text-accent-foreground hover:bg-accent/90'
              >
              ...
              <button
                ...
                className='flex items-center gap-2 px-4 py-2 rounded-lg font-medium transition-all bg-primary text-primary-foreground hover:bg-primary/90'
              >
                Next
